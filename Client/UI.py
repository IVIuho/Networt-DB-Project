...
class Ui_FileDownloader(object):
    def setupUi(self, FileDownloader):
        ...
        FileDownloader.setStyleSheet(_fromUtf8("background-color: rgb(65, 65, 65);"))
        ...
        self.btn_connect.setStyleSheet(_fromUtf8("color: rgb(240, 240, 240);"))
        ...
        self.label_connect.setWordWrap(False)
        ...
        self.btn_download.setStyleSheet(_fromUtf8("color: rgb(240, 240, 240);"))
        ...
        self.btn_path.setStyleSheet(_fromUtf8("color: rgb(240, 240, 240);"))
        ...
        self.list_item.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        ...
        self.btn_disconnect.setStyleSheet(_fromUtf8("color: rgb(240, 240, 240);"))
        self.btn_disconnect.setFlat(False)
        self.btn_disconnect.setObjectName(_fromUtf8("btn_disconnect"))
        self.label_progress = QtGui.QLabel(self.MainWidget)
        self.label_progress.setGeometry(QtCore.QRect(13, 600, 451, 31))
        ...
        self.list_item.setCurrentRow(-1)
    ...
    def retranslateUi(self, FileDownloader):
        ...
        self.label_connect.setText(_translate("FileDownloader", "<html><head/><body><p><span style=\" color:#ffffff;\">접속 대기 중...</span></p></body></html>", None))
        self.btn_download.setText(_translate("FileDownloader", "다운로드", None))
        self.label_download.setText(_translate("FileDownloader", "<html><head/><body><p><span style=\" color:#ffffff;\">다운로드 대기 중...</span></p></body></html>", None))
        ...
        self.label_desc.setText(_translate("FileDownloader", "<html><head/><body><p><span style=\" color:#ffffff;\">서버의 공유 파일 리스트</span></p></body></html>", None))
        self.btn_disconnect.setText(_translate("FileDownloader", "해제", None))
        self.label_progress.setText(_translate("FileDownloader", "<html><head/><body><p><span style=\" color:#ffffff;\">0%</span></p></body></html>", None))
